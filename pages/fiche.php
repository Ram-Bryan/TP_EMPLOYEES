...
<html>
    ...
    <div class="container">
        <p><a href="javascript:history.back()" class="btn btn-secondary">&larr; Retour</a></p>
        ...
        <?php } else { ?>
            ...
            <p>
                ...
                <a href="become_manager.php?emp_no=<?= urlencode($employee['emp_no']) ?>" class="btn">Devenir Manager</a>
                <a href="emp_form.php?emp_no=<?= urlencode($employee['emp_no']) ?>" class="btn">Modifier l'employé</a>
            </p>
